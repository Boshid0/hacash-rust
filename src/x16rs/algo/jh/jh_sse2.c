...
typedef struct
{
    ...
    uint64_t databitlen;                    /*the message size in bits*/
    uint64_t datasize_in_buffer;            /*the size of the message remained in buffer; assumed to be multiple of 8bits except for the last partial block at the end of the message*/
    __m128i x0, x1, x2, x3, x4, x5, x6, x7; /*1024-bit ctx;*/
    unsigned char buffer[64];               /*512-bit message block;*/
} jh_context;

/*The API functions*/
int jh_init(jh_context *ctx);
int jh_update(jh_context *ctx, const void *data, uint64_t databitlen);
int jh_finalize(jh_context *ctx, void *hashval);
// static int Hash(int hashbitlen, const uint8_t *data,uint64_t databitlen, uint8_t *hashval);

/*The initial hash value H(0)*/
static DATA_ALIGN16(const unsigned char JH224_H0[128]) = {0x2d, 0xfe, 0xdd, 0x62, 0xf9, 0x9a, 0x98, 0xac, 0xae, 0x7c, 0xac, 0xd6, 0x19, 0xd6, 0x34, 0xe7, 0xa4, 0x83, 0x10, 0x5, 0xbc, 0x30, 0x12, 0x16, 0xb8, 0x60, 0x38, 0xc6, 0xc9, 0x66, 0x14, 0x94, 0x66, 0xd9, 0x89, 0x9f, 0x25, 0x80, 0x70, 0x6f, 0xce, 0x9e, 0xa3, 0x1b, 0x1d, 0x9b, 0x1a, 0xdc, 0x11, 0xe8, 0x32, 0x5f, 0x7b, 0x36, 0x6e, 0x10, 0xf9, 0x94, 0x85, 0x7f, 0x2, 0xfa, 0x6, 0xc1, 0x1b, 0x4f, 0x1b, 0x5c, 0xd8, 0xc8, 0x40, 0xb3, 0x97, 0xf6, 0xa1, 0x7f, 0x6e, 0x73, 0x80, 0x99, 0xdc, 0xdf, 0x93, 0xa5, 0xad, 0xea, 0xa3, 0xd3, 0xa4, 0x31, 0xe8, 0xde, 0xc9, 0x53, 0x9a, 0x68, 0x22, 0xb4, 0xa9, 0x8a, 0xec, 0x86, 0xa1, 0xe4, 0xd5, 0x74, 0xac, 0x95, 0x9c, 0xe5, 0x6c, 0xf0, 0x15, 0x96, 0xd, 0xea, 0xb5, 0xab, 0x2b, 0xbf, 0x96, 0x11, 0xdc, 0xf0, 0xdd, 0x64, 0xea, 0x6e};
static DATA_ALIGN16(const unsigned char JH256_H0[128]) = {0xeb, 0x98, 0xa3, 0x41, 0x2c, 0x20, 0xd3, 0xeb, 0x92, 0xcd, 0xbe, 0x7b, 0x9c, 0xb2, 0x45, 0xc1, 0x1c, 0x93, 0x51, 0x91, 0x60, 0xd4, 0xc7, 0xfa, 0x26, 0x0, 0x82, 0xd6, 0x7e, 0x50, 0x8a, 0x3, 0xa4, 0x23, 0x9e, 0x26, 0x77, 0x26, 0xb9, 0x45, 0xe0, 0xfb, 0x1a, 0x48, 0xd4, 0x1a, 0x94, 0x77, 0xcd, 0xb5, 0xab, 0x26, 0x2, 0x6b, 0x17, 0x7a, 0x56, 0xf0, 0x24, 0x42, 0xf, 0xff, 0x2f, 0xa8, 0x71, 0xa3, 0x96, 0x89, 0x7f, 0x2e, 0x4d, 0x75, 0x1d, 0x14, 0x49, 0x8, 0xf7, 0x7d, 0xe2, 0x62, 0x27, 0x76, 0x95, 0xf7, 0x76, 0x24, 0x8f, 0x94, 0x87, 0xd5, 0xb6, 0x57, 0x47, 0x80, 0x29, 0x6c, 0x5c, 0x5e, 0x27, 0x2d, 0xac, 0x8e, 0xd, 0x6c, 0x51, 0x84, 0x50, 0xc6, 0x57, 0x5, 0x7a, 0xf, 0x7b, 0xe4, 0xd3, 0x67, 0x70, 0x24, 0x12, 0xea, 0x89, 0xe3, 0xab, 0x13, 0xd3, 0x1c, 0xd7, 0x69};
static DATA_ALIGN16(const unsigned char JH384_H0[128]) = {0x48, 0x1e, 0x3b, 0xc6, 0xd8, 0x13, 0x39, 0x8a, 0x6d, 0x3b, 0x5e, 0x89, 0x4a, 0xde, 0x87, 0x9b, 0x63, 0xfa, 0xea, 0x68, 0xd4, 0x80, 0xad, 0x2e, 0x33, 0x2c, 0xcb, 0x21, 0x48, 0xf, 0x82, 0x67, 0x98, 0xae, 0xc8, 0x4d, 0x90, 0x82, 0xb9, 0x28, 0xd4, 0x55, 0xea, 0x30, 0x41, 0x11, 0x42, 0x49, 0x36, 0xf5, 0x55, 0xb2, 0x92, 0x48, 0x47, 0xec, 0xc7, 0x25, 0xa, 0x93, 0xba, 0xf4, 0x3c, 0xe1, 0x56, 0x9b, 0x7f, 0x8a, 0x27, 0xdb, 0x45, 0x4c, 0x9e, 0xfc, 0xbd, 0x49, 0x63, 0x97, 0xaf, 0xe, 0x58, 0x9f, 0xc2, 0x7d, 0x26, 0xaa, 0x80, 0xcd, 0x80, 0xc0, 0x8b, 0x8c, 0x9d, 0xeb, 0x2e, 0xda, 0x8a, 0x79, 0x81, 0xe8, 0xf8, 0xd5, 0x37, 0x3a, 0xf4, 0x39, 0x67, 0xad, 0xdd, 0xd1, 0x7a, 0x71, 0xa9, 0xb4, 0xd3, 0xbd, 0xa4, 0x75, 0xd3, 0x94, 0x97, 0x6c, 0x3f, 0xba, 0x98, 0x42, 0x73, 0x7f};
...
static DATA_ALIGN16(const unsigned char E8_bitslice_roundconstant[42][32]) = {
...
static void F8(jh_context *ctx); /* the compression function F8 */
...
static void F8(jh_context *ctx)
{
    ...
    /*xor the 512-bit message with the fist half of the 1024-bit hash ctx*/
    y0 = XOR(y0, LOAD(ctx->buffer));
    y1 = XOR(y1, LOAD(ctx->buffer + 16));
    y2 = XOR(y2, LOAD(ctx->buffer + 32));
    y3 = XOR(y3, LOAD(ctx->buffer + 48));
    ...
    /*xor the 512-bit message with the second half of the 1024-bit hash ctx*/
    y4 = XOR(y4, LOAD(ctx->buffer));
    y5 = XOR(y5, LOAD(ctx->buffer + 16));
    y6 = XOR(y6, LOAD(ctx->buffer + 32));
    y7 = XOR(y7, LOAD(ctx->buffer + 48));
...
/*before hashing a message, initialize the hash ctx as H0 */
int jh_init(jh_context *ctx)
{
    int hashbitlen = 512;
    ctx->databitlen = 0;
    ...
    /*load the intital hash value into ctx*/

    switch (hashbitlen)
    {
    case 224:
        ctx->x0 = LOAD(JH224_H0);
        ctx->x1 = LOAD(JH224_H0 + 16);
        ctx->x2 = LOAD(JH224_H0 + 32);
        ctx->x3 = LOAD(JH224_H0 + 48);
        ctx->x4 = LOAD(JH224_H0 + 64);
        ctx->x5 = LOAD(JH224_H0 + 80);
        ctx->x6 = LOAD(JH224_H0 + 96);
        ctx->x7 = LOAD(JH224_H0 + 112);
        break;

    case 256:
        ctx->x0 = LOAD(JH256_H0);
        ctx->x1 = LOAD(JH256_H0 + 16);
        ctx->x2 = LOAD(JH256_H0 + 32);
        ctx->x3 = LOAD(JH256_H0 + 48);
        ctx->x4 = LOAD(JH256_H0 + 64);
        ctx->x5 = LOAD(JH256_H0 + 80);
        ctx->x6 = LOAD(JH256_H0 + 96);
        ctx->x7 = LOAD(JH256_H0 + 112);
        break;

    case 384:
        ctx->x0 = LOAD(JH384_H0);
        ctx->x1 = LOAD(JH384_H0 + 16);
        ctx->x2 = LOAD(JH384_H0 + 32);
        ctx->x3 = LOAD(JH384_H0 + 48);
        ctx->x4 = LOAD(JH384_H0 + 64);
        ctx->x5 = LOAD(JH384_H0 + 80);
        ctx->x6 = LOAD(JH384_H0 + 96);
        ctx->x7 = LOAD(JH384_H0 + 112);
        break;

    case 512:
        ctx->x0 = LOAD(JH512_H0);
        ctx->x1 = LOAD(JH512_H0 + 16);
        ctx->x2 = LOAD(JH512_H0 + 32);
        ctx->x3 = LOAD(JH512_H0 + 48);
        ctx->x4 = LOAD(JH512_H0 + 64);
        ctx->x5 = LOAD(JH512_H0 + 80);
        ctx->x6 = LOAD(JH512_H0 + 96);
        ctx->x7 = LOAD(JH512_H0 + 112);
        break;
    }
...
int jh_update(jh_context *ctx, const void *data, uint64_t databitlen)
{
    uint64_t index; /*the starting address of the data to be compressed*/
    databitlen = (databitlen << 3);
    ...
    if ((ctx->datasize_in_buffer > 0) && ((ctx->datasize_in_buffer + databitlen) < 512))
    {
        if ((databitlen & 7) == 0)
        {
            memcpy(ctx->buffer + (ctx->datasize_in_buffer >> 3), data, 64 - (ctx->datasize_in_buffer >> 3));
        }
        else
            memcpy(ctx->buffer + (ctx->datasize_in_buffer >> 3), data, 64 - (ctx->datasize_in_buffer >> 3) + 1);
    ...
    {
        memcpy(ctx->buffer, data + index, 64);
        F8(ctx);
    }
    ...
    {
        if ((databitlen & 7) == 0)
            memcpy(ctx->buffer, data + index, (databitlen & 0x1ff) >> 3);
        else
            memcpy(ctx->buffer, data + index, ((databitlen & 0x1ff) >> 3) + 1);
        ctx->datasize_in_buffer = databitlen;
    }
...
int jh_finalize(jh_context *ctx, void *hashval)
{
    ...
    if ((ctx->databitlen & 0x1ff) == 0)
    {
        ...
        ctx->buffer[0] = 0x80;
        ctx->buffer[63] = ctx->databitlen & 0xff;
        ctx->buffer[62] = (ctx->databitlen >> 8) & 0xff;
        ctx->buffer[61] = (ctx->databitlen >> 16) & 0xff;
        ctx->buffer[60] = (ctx->databitlen >> 24) & 0xff;
        ctx->buffer[59] = (ctx->databitlen >> 32) & 0xff;
        ctx->buffer[58] = (ctx->databitlen >> 40) & 0xff;
        ctx->buffer[57] = (ctx->databitlen >> 48) & 0xff;
        ctx->buffer[56] = (ctx->databitlen >> 56) & 0xff;
        F8(ctx);
    }
    else
    {
        ...
        if ((ctx->datasize_in_buffer & 7) == 0)
            for (i = (ctx->databitlen & 0x1ff) >> 3; i < 64; i++)
                ctx->buffer[i] = 0;
        else
            for (i = ((ctx->databitlen & 0x1ff) >> 3) + 1; i < 64; i++)
                ctx->buffer[i] = 0;
    ...
    {
    case 224:
        memcpy(hashval, t + 36, 28);
        break;
    case 256:
        memcpy(hashval, t + 32, 32);
        break;
    case 384:
        memcpy(hashval, t + 16, 48);
        break;
    case 512:
        memcpy(hashval, t, 64);
        break;
...
#define jh512_context jh_context
#define jh512_init    jh_init
#define jh512_update  jh_update
#define jh512_close   jh_finalize
...
//       {
//           jh_init(&ctx, hashbitlen);
//           jh_update(&ctx, data, databitlen);
//           jh_finalize(&ctx, hashval);
//           return 0;
//       }
//       else
//           return(2);
...
// {
// 	int ret = Hash(bit_len, input, input_bit_length, output);
// 	assert(ret == 0);
// }