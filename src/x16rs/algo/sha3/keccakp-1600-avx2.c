...
#define SET_256(i0, i1, i2, i3)             _mm256_setr_epi64x(i0, i1, i2, i3)
...
#define MASKLOAD(p, i0, i1, i2, i3)     _mm256_maskload_epi64((const INT64 *)(p), \
                                            SET_256((UINT64)(i0) << 63, (UINT64)(i1) << 63, (UINT64)(i2) << 63, (UINT64)(i3) << 63))
#define MASKSTORE(p, i0, i1, i2, i3, a) _mm256_maskstore_epi64((INT64 *)(p), \
                                            SET_256((UINT64)(i0) << 63, (UINT64)(i1) << 63, (UINT64)(i2) << 63, (UINT64)(i3) << 63), a)
#define LOAD_256(p)                         _mm256_loadu_si256((const __m256i *)(p))
#define STORE_256(p, a)                     _mm256_storeu_si256((__m256i *)(p), a)
...
#define ROLV_CONST(name, i0, i1, i2, i3) \
    ROLV_TYPE  SLLV##name = SET_256(i0, i1, i2, i3); \
    ROLV_TYPE  SRLV##name = SET_256(64 - i0, 64 - i1, 64 - i2, 64 - i3);

#define _ROLV_CONST(name, i0, i1, i2, i3) \
    _ROLV_TYPE  SLLV##name = SET_256(i0, i1, i2, i3); \
    _ROLV_TYPE  SRLV##name = SET_256(64 - i0, 64 - i1, 64 - i2, 64 - i3);
...
#define ROLV(a, name) \
    XOR_256(_mm256_sllv_epi64(a, SLLV##name), \
        _mm256_srlv_epi64(a, SRLV##name))

#define ROL(a, i) \
    XOR_256(_mm256_slli_epi64(a, i), \
        _mm256_srli_epi64(a, 64 - i))
/*
#define ROLV(a, i0, i1, i2, i3) \
    XOR_256(_mm256_sllv_epi64(a, SET_256(i0, i1, i2, i3)), \
        _mm256_srlv_epi64(a, SET_256(64 - i0, 64 - i1, 64 - i2, 64 - i3)))
*/
...
/*********************************/\
    ...
    { \
        ...
        r0 = XOR_256(r0, a2); \
        r0 = XOR_256(r0, a3); \
        r0 = XOR_256(r0, a4);                   /*C[0, 1, 2, 3]*/ \
\
        r1 = XOR_256(c4, _mm256_permute2x128_si256(c4, c4, 0x11)); \
        r1 = XOR_256(r1, _mm256_unpackhi_epi64(r1, r1)); \
        r1 = XOR_256(r1, a44);                  /*C[4]*/ \
\
...
\
        a44 = XOR_256(a44, b04); \
        c4 = XOR_256(c4, _mm256_broadcastq_epi64(_mm256_castsi256_si128(b04))); \
\
...
\
        ...
        a0 = XOR_256(b0, _mm256_andnot_si256(b1, b2)); \
        a0 = XOR_256(a0, *(__m256i *)(keccak_rc + round_i)); \
\
        a1 = XOR_256(b1, _mm256_andnot_si256(b2, b3)); \
        a2 = XOR_256(b2, _mm256_andnot_si256(b3, b4)); \
        a3 = XOR_256(b3, _mm256_andnot_si256(b4, b0)); \
        c4 = XOR_256(b4, _mm256_andnot_si256(b0, b1)); \
\
...
\
        a04 = XOR_256(b04, _mm256_andnot_si256(b14, b24)); \
        a14 = XOR_256(b14, _mm256_andnot_si256(b24, b34)); \
        a24 = XOR_256(b24, _mm256_andnot_si256(b34, b44)); \
        a34 = XOR_256(b34, _mm256_andnot_si256(b44, b04)); \
        a44 = XOR_256(b44, _mm256_andnot_si256(b04, b14)); \
\
...
//*********************************************************************************
{
    ...
    STORE_256(d + 0*5, s->a0);
    STORE_256(d + 1*5, s->a1);
    STORE_256(d + 2*5, s->a2);
    STORE_256(d + 3*5, s->a3);
    STORE_256(d + 4*5, s->a4);
...
*/
    ...
    s->a3 = LOAD_256(t + 3*5);
    s->a4 = LOAD_256(t + 4*5);
    s->c4 = SET_256(t[0*5 + 4], t[1*5 + 4], t[2*5 + 4], t[3*5 + 4]);
...
//**************************************************************************************************************
{
    ...
    for (di = 0; di <= (ptrdiff_t)(dataByteLen / sizeof(UINT64) - laneCount); di += laneCount)
    {
        ...
        {
        case 9:     //576
            a0 = XOR_256(a0, LOAD_256(d + 0*5));
            a1 = XOR_256(a1, LOAD_256(d + 1*5));
            c4 = XOR_256(c4, MASKLOAD(d + 0*5 + 4, 1, 0, 0, 0));
            break;

        case 13:    //832
            a0 = XOR_256(a0, LOAD_256(d + 0*5));
            a1 = XOR_256(a1, LOAD_256(d + 1*5));
            a2 = XOR_256(a2, MASKLOAD(d + 2*5, 1, 1, 1, 0));
            c4 = XOR_256(c4, SET_256(d[0*5 + 4], d[1*5 + 4], 0, 0));
            break;

        case 16:    //1024
            a0 = XOR_256(a0, LOAD_256(d + 0*5));
            a1 = XOR_256(a1, LOAD_256(d + 1*5));
            a2 = XOR_256(a2, LOAD_256(d + 2*5));
            a3 = XOR_256(a3, MASKLOAD(d + 3*5, 1, 0, 0, 0));
            c4 = XOR_256(c4, SET_256(d[0*5 + 4], d[1*5 + 4], d[2*5 + 4], 0));
            break;
        ...
        case 17:    //1088
            ...
            a1 = XOR_256(a1, LOAD_256(d + 1*5));
            a2 = XOR_256(a2, LOAD_256(d + 2*5));
            a3 = XOR_256(a3, MASKLOAD(d + 3*5, 1, 1, 0, 0));
            c4 = XOR_256(c4, SET_256(d[0*5 + 4], d[1*5 + 4], d[2*5 + 4], 0));
            break;
        ...
        case 18:    //1152
            ...
            a1 = XOR_256(a1, LOAD_256(d + 1*5));
            a2 = XOR_256(a2, LOAD_256(d + 2*5));
            a3 = XOR_256(a3, MASKLOAD(d + 3*5, 1, 1, 1, 0));
            c4 = XOR_256(c4, SET_256(d[0*5 + 4], d[1*5 + 4], d[2*5 + 4], 0));
            break;
        ...
        case 21:    //1344
            ...
            a1 = XOR_256(a1, LOAD_256(d + 1*5));
            a2 = XOR_256(a2, LOAD_256(d + 2*5));
            a3 = XOR_256(a3, LOAD_256(d + 3*5));
            a4 = XOR_256(a4, MASKLOAD(d + 4*5, 1, 0, 0, 0));
            c4 = XOR_256(c4, SET_256(d[0*5 + 4], d[1*5 + 4], d[2*5 + 4], d[3*5 + 4]));
            break;
        ...
        case 25:    //1600
            ...
            a2 = XOR_256(a2, LOAD_256(d + 2*5));
            a3 = XOR_256(a3, LOAD_256(d + 3*5));
            a4 = XOR_256(a4, LOAD_256(d + 4*5));
            c4 = XOR_256(c4, SET_256(d[0*5 + 4], d[1*5 + 4], d[2*5 + 4], d[3*5 + 4]));
            a44 = XOR_256(a44, LOAD0(d + 4*5 + 4));
            break;
...
{
    keccak_state_t state_t;
    keccak_state_t *state = &state_t;
    ...
    if (((rateInBytes % (SnP_width/200)) == 0) && (inputByteLen >= rateInBytes)) {
        ...
        size_t j;
        j = KeccakF1600_FastLoop_Absorb(state, rateInBytes/(SnP_width/200), curInput, inputByteLen);
        curInput += j;
        inputByteLen -= j;
    }
#endif
...
#undef SnP_width
#undef SnP_Permute
#undef KeccakF1600_FastLoop_supported
