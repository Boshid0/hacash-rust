...
#define SCAT(x, y)     XCAT_(x, y)
#define XCAT_(x, y)    x ## y

#define SKBI(k, s, i)   SCAT(k, SCAT(SCAT(SCAT(M9_, s), _), i))
#define SKBT(t, s, v)   SCAT(t, SCAT(SCAT(SCAT(M3_, s), _), v))
