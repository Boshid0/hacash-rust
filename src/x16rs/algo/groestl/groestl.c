...
#define DECL_STATE_SMALL_groestl \
	sph_u64 H[8];

#define READ_STATE_SMALL_groestl(sc)   do { \
		memcpy(H, (sc)->state.wide, sizeof H); \
	} while (0)

#define WRITE_STATE_SMALL_groestl(sc)   do { \
