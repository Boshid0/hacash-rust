...
//#define _ROTL64(a,n) ((((a)<<(n))|((a)>>(64-(n))))&li_64(ffffffffffffffff))
#define _ROTL64(a,n) rol64( a, n )
...
#define U64BIG(a) \
  ((_ROTL64(a, 8) & li_64(000000FF000000FF)) | \
   (_ROTL64(a,24) & li_64(0000FF000000FF00)) | \
   (_ROTL64(a,40) & li_64(00FF000000FF0000)) | \
   (_ROTL64(a,56) & li_64(FF000000FF000000)))
